...
* Income Growth
tw (connect beta_w_2013 wbin, lcolor("32 178 170") mcolor("32 178 170 %34")) (rcap cilow_w_2013 cihigh_w_2013 wbin, lpattern(solid) lcolor("32 178 170")) (connect beta_w_2012 wbin, lpattern(solid) lcolor("251 162 127") mcolor("251 162 127 %34") ) (rcap cilow_w_2012 cihigh_w_2012 wbin, lpattern(solid) lcolor("251 162 127")) (connect beta_w_2011 wbin, msymbol(T) lpattern(solid) lcolor("150 79 142") mcolor("150 79 142 %34")  ) (rcap cilow_w_2011 cihigh_w_2011 wbin, lpattern(solid) lcolor("150 79 142")), xline(373, lcolor(red%85)) yline(0, lcolor(black%25)) xlabel(289(28)1017, alternate) xtitle("Monthly Income Bins") ytitle("Income Growth")   legend(order( 1 "2012-2013" 3 "2011-2012" 5 "2010-2011") col(3)) ylabel(-0.05(0.05)0.45) 
...
tw (connect beta_e_2013 wbin, lcolor("32 178 170") mcolor("32 178 170 %34")) (rcap cilow_e_2013 cihigh_e_2013 wbin, lpattern(solid) lcolor("32 178 170")) (connect beta_e_2012 wbin, lpattern(solid) lcolor("251 162 127") mcolor("251 162 127 %34")) (rcap cilow_e_2012 cihigh_e_2012 wbin, lpattern(solid) lcolor("251 162 127")) (connect beta_e_2011 wbin, msymbol(T) lpattern(solid) lcolor("150 79 142") mcolor("150 79 142 %34") ) (rcap cilow_e_2011 cihigh_e_2011 wbin, lpattern(solid) lcolor("150 79 142")), xline(373, lcolor(red%85)) yline(0, lcolor(black%25)) xlabel(289(28)1017, alternate) xtitle("Monthly Income Bins") ytitle("Stay in Employment")   legend(order( 1 "2012-2013" 3 "2011-2012" 5 "2010-2011") col(3)) ylabel(-0.20(0.04)0.04) 
